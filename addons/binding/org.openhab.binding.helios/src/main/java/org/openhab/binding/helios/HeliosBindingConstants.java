...
/**
 * The {@link HeliosBinding} class defines common constants, which are
...
public class HeliosBindingConstants {
    ...
    public final static ThingTypeUID THING_TYPE_HELIOS = new ThingTypeUID(BINDING_ID, "helios");
    ...
    public final static String PART_MODE_STATUS = "partModeStatus";
    ...
    public final static String CONFIG_UNIT = "unit";
    public final static String CONFIG_START_ADDRESS = "startAddress";
}
