...
import static org.openhab.binding.helios.HeliosBindingConstants.THING_TYPE_HELIOS;
...
public class HeliosHandlerFactory extends BaseThingHandlerFactory {
    ...
    private final static Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Collections.singleton(THING_TYPE_HELIOS);
    ...
    protected ThingHandler createHandler(Thing thing) {
        ...
        if (thingTypeUID.equals(THING_TYPE_HELIOS)) {
