...
/**
 * Test cases for {@link Client.parseMultiPointCoverageXml} with a xml response having single place and multiple
 * parameters
 * and timestamps
 *
...
public class FMIResponseParsingSinglePlaceTest extends AbstractFMIResponseParsingTest {
    ...
    public void setUp() throws Throwable {
        observationsResponse1 = parseMultiPointCoverageXml(new String(Files.readAllBytes(observations1)));
        observationsResponse1NaN = parseMultiPointCoverageXml(
                new String(Files.readAllBytes(observations1)).replace("276.0", "NaN"));
